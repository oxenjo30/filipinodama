...
/**
 * LegalPage (/legal) — Legal & Policies hub. Reproduces the handoff prototype
 * (lines 1029-1076) verbatim: a sticky tab sidebar switching between four static
 * policy documents (Privacy Policy, Terms of Service, Community Guidelines,
 * Data & Account Controls), each rendered with numbered sections and a contact
 * block. Reached from Settings › "Privacy & Terms" and the footer.
 *
 * Policy copy is static legal text (not user data) — this is the source of truth
 * from the prototype's `_legalData()`, transcribed exactly.
 */
...
type LegalKey = "privacy" | "terms" | "community" | "data";
...
const TABS: { key: LegalKey; label: string; icon: string }[] = [
  { key: "privacy", label: "Privacy Policy", icon: "🔒" },
  { key: "terms", label: "Terms of Service", icon: "📜" },
  { key: "community", label: "Community Guidelines", icon: "🤝" },
